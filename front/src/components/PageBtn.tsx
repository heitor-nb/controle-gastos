...
const PageBtn : FunctionComponent<PageBtnProps> = ({ width, variant, text, onClick, disabled }) => {
    ...
    return (
        <Btn $width={width} $variant={variant} style={disabled ? disabledStyle : undefined} onClick={onClick}>
            {text}
        </Btn>
    )
}
